...
import { StyleSheet, Text, View, StatusBar ,ScrollView, Image, TouchableOpacity, ActivityIndicator, Flatlist } from 'react-native';
                        ...
                        <View key ={item.id}>
                          ...
                          <View style={styles.itemcard}>  
                              ...
                              <View style={styles.descriptionview}>
                                    <Text style={styles.ratecount}>Category: {item.category}</Text>                                       
